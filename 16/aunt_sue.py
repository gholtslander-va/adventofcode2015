...
def check_evidence(evidence_key, amount):
    if evidence_key in ['pomeranians', 'goldfish']:
        return amount < evidence[evidence_key]
    elif evidence_key in ['cats', 'trees']:
        return amount > evidence[evidence_key]
    else:
        return amount == evidence[evidence_key]
...
potential_sues = []
for sue in testinput:
    sue_split = sue.split(' ')
    sue_number = int(sue_split[1].rstrip(':'))
    evidence_1 = sue_split[2].rstrip(':')
    evidence_1_amount = int(sue_split[3].rstrip(','))
    evidence_2 = sue_split[4].rstrip(':')
    evidence_2_amount = int(sue_split[5].rstrip(','))
    evidence_3 = sue_split[6].rstrip(':')
    evidence_3_amount = int(sue_split[7].strip())

    if all([check_evidence(evidence_1, evidence_1_amount),
            check_evidence(evidence_2, evidence_2_amount),
            check_evidence(evidence_3, evidence_3_amount)]):
        potential_sues.append(sue_number)

print potential_sues
